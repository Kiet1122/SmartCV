...
![Llama](https://img.shields.io/badge/Llama-3.1-FF6B6B?style=for-the-badge&logo=meta&logoColor=white)
...
Dự án được xây dựng theo kiến trúc **Decoupled (Microservices)** , tách biệt giữa logic nghiệp vụ và xử lý AI:
...
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────────────────┐  │
│  │ Candidate   │  │ Recruiter   │  │ Admin Panel             │  │
...
│   CV Parsing       │ │ Semantic Matching  │ │  Job Approval      │
│   (Llama 3.1)      │ │ (Sentence-Transform)│ │  (Llama 3.1)       │
└───────────────────┘ └───────────────────┘ └───────────────────┘
                                    │
                                    ▼
                    ┌───────────────────────────────────┐
                    │   Dual-Agent AI - Port 8080        │
                    │   (CV Review với 2 luồng độc lập)  │
                    └───────────────────────────────────┘
```
